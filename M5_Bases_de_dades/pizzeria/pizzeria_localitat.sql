...
CREATE TABLE `localitat` (
  ...
  KEY `fk_localitat_provincia1_idx` (`provincia_id_provincia`),
  CONSTRAINT `fk_localitat_provincia1` FOREIGN KEY (`provincia_id_provincia`) REFERENCES `provincia` (`id_provincia`)
...
INSERT INTO `localitat` VALUES (1,'Manresa',2),(2,'Monells',1);
