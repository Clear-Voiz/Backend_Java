...
CREATE TABLE `tipus` (
  ...
  `nom` varchar(45) NOT NULL COMMENT 's''afegiran 3 files amb els noms: pizza, hamburguesa i beguda. s''empraran per etiquetar un producte com a una d''aquestes tres categories',
...
INSERT INTO `tipus` VALUES (1,'pizza'),(2,'hamburguesa'),(3,'beguda');
